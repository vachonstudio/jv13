      ...
      const favoriteItems = favoriteIds.map(id => {
        ...
        if (content) {
          return {
            id,
            type: activeTab,
            title: (activeTab === 'project' ? (content as Project).title : (content as Gradient).name) || 'Untitled',
            image: (activeTab === 'project' ? (content as Project).image : (content as Gradient).css),
            description: (activeTab === 'project' ? (content as Project).description : (content as Gradient).description) || '',
            category: content.category,
            tags: (activeTab === 'project' ? (content as Project).technologies : (content as Gradient).tags),
            isPrivate: activeTab === 'project' ? (content as Project).visibility === 'private' : false,
